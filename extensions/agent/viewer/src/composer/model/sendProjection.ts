...
export function buildComposerSendParts(snapshot: ComposerSnapshot): ComposerSendProjection {
  const parts: AgentComposerMessagePart[] = [];
...
/** @deprecated Use buildComposerSendParts for structured Agent input. */
export const buildComposerSendProjection = buildComposerSendParts;

function pushTextPart(parts: AgentComposerMessagePart[], text: string) {
