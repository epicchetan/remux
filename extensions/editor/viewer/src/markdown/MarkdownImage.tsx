...
function ImagePlaceholder({
  ...
  return (
    <span className="remux-viewer-markdown-image-placeholder">
      <span className="remux-viewer-markdown-image-placeholder-title">
        {message}
      </span>
      {alt ? (
        <span className="remux-viewer-markdown-image-placeholder-alt">
          {alt}
        </span>
      ) : null}
    </span>
