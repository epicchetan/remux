...
| [agent-new-chat-recovery.md](agent-new-chat-recovery.md) | Implemented — live recovery verified | Recover accepted creation and first-message results after reconnect/reload; preserve draft edits and stable request identities. |
