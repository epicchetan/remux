...
| Spec | Status | Notes |
| --- | --- | --- |
| [html-file-preview-v1.md](html-file-preview-v1.md) | Active Spec — implemented; native rollout gated | Interactive self-contained HTML in the existing file tab: bridge-free WebView, Preview/Source, bounded 5 MiB loading and trusted companion links. Automated checks and iOS/Android exports pass; native validation and publication remain. |
