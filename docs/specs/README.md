...
| [agent-new-chat-recovery.md](agent-new-chat-recovery.md) | Active Spec — current implementation priority | Recover accepted creation and first-message results after reconnect/reload; preserve draft edits and stable request identities. |
