...
| Spec | Status | Notes |
| --- | --- | --- |
| [html-file-preview-v1.md](html-file-preview-v1.md) | Implemented — Expo publication pending | Interactive self-contained HTML in the existing file tab: bridge-free WebView, Preview/Source, bounded 5 MiB loading and trusted companion links. Automated checks and iOS/Android exports pass; native platforms enabled for release at the user's direction. |
