...
| [agent-subagent-lifecycle.md](agent-subagent-lifecycle.md) | Implemented — deployed with live acceptance | Durable agent/assignment identity, restart reconciliation, conversation/child Stop, evidence-based phantom repair and a composer-button activity badge. Broader audit remains paused. |
