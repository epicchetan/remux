...
| [agent-subagent-lifecycle.md](agent-subagent-lifecycle.md) | Implemented — deployed with live acceptance | Durable agent/assignment identity, restart reconciliation, conversation/child Stop, evidence-based phantom repair and one stable bottom activity row. Broader audit remains paused. |
