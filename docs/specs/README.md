...
| Spec | Status | Notes |
| --- | --- | --- |
| [html-file-preview-v1.md](html-file-preview-v1.md) | Active Spec — implementation pending | Interactive self-contained HTML in the existing file tab: app-owned bridge-free WebView, Preview/Source, bounded 5 MiB loading, trusted companion links, native isolation gate and staged Sol implementation. |
