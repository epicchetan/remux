...
const policyList = [
  ...
  definePolicy({ name: 'codex-app-server-status-read', method: 'remux/codex/app-server/status/read', effect: 'read', completion: 'bounded-local-work', lane: 'codex:app-server-management', budget: { connectWaitMs: 3_000, queueMs: 1_000, executionMs: 10_000, transferMs: 1_000, totalMs: 15_000 }, timeoutHealth: 'route-only', retry: 'read-safe', downstreamRetry: 'never', executionDeadlineOutcome: 'canceled' }),
  definePolicy({ name: 'codex-app-server-start', method: 'remux/codex/app-server/start', effect: 'convergent-mutation', completion: 'long-operation', lane: 'codex:app-server-management', budget: { connectWaitMs: 3_000, queueMs: 2_000, executionMs: 30_000, transferMs: 2_000, totalMs: 40_000 }, timeoutHealth: 'route-only', retry: 'never', downstreamRetry: 'never', executionDeadlineOutcome: 'may-complete-outcome-unknown' }),
  definePolicy({ name: 'codex-app-server-stop', method: 'remux/codex/app-server/stop', effect: 'convergent-mutation', completion: 'long-operation', lane: 'codex:app-server-management', budget: { connectWaitMs: 3_000, queueMs: 2_000, executionMs: 30_000, transferMs: 2_000, totalMs: 40_000 }, timeoutHealth: 'route-only', retry: 'never', downstreamRetry: 'never', executionDeadlineOutcome: 'may-complete-outcome-unknown' }),
  definePolicy({ name: 'codex-app-server-restart', method: 'remux/codex/app-server/restart', effect: 'mutation', completion: 'long-operation', lane: 'codex:app-server-management', budget: { connectWaitMs: 3_000, queueMs: 2_000, executionMs: 30_000, transferMs: 2_000, totalMs: 40_000 }, timeoutHealth: 'route-only', retry: 'never', downstreamRetry: 'never', executionDeadlineOutcome: 'may-complete-outcome-unknown' }),
  definePolicy({ name: 'codex-app-server-update', method: 'remux/codex/app-server/update', effect: 'mutation', completion: 'long-operation', lane: 'codex:app-server-management', budget: { connectWaitMs: 6_000, queueMs: 5_000, executionMs: 580_000, transferMs: 5_000, totalMs: 600_000 }, timeoutHealth: 'operation-only', retry: 'never', downstreamRetry: 'never', executionDeadlineOutcome: 'may-complete-outcome-unknown' }),
